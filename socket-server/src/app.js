...
io.on('connection', socket => {
    ...
    socket.on('idle', state => {
        io.emit('idlestate', state );
    });
    ...
    socket.on('gettabledata',() => {
        //radar chart data
           io.emit('tbldata', {type:'tbldata', data:[{
            id: 1,
            firstName: 'Mark',
            lastName: 'Otto',
            username: '@mdo',
    ...
    // socket.on('getlinechart',() => {
    //     //radar chart data
    //    io.emit('linechart', {type:'linechart', data: {seriesA:[65, 59, 90, 81, 56, 55, 40],seriesB:[28, 48, 40, 19, 96, 27, 100]}});
    // });

    // socket.on('getmultiplechart',() => {
    // //radar chart data
    //    io.emit('multiplechart', {type:'multiplechart', data: {seriesA:[65, 59, 90, 81, 56, 55, 40],seriesB:[28, 48, 40, 19, 96, 27, 100]}});
    // });
